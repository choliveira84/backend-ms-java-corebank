...
public class AuthorizeTransactionUseCaseImpl implements AuthorizeTransactionUseCase {
    ...
    @Override
    @Transactional
    public AuthorizeTransactionUseCase.AuthorizeTransactionResult execute(
            AuthorizeTransactionUseCase.AuthorizeTransactionCommand command) {
        AccountLedger ledger = ledgerRepository.findByAccountId(command.accountId())
        ...
        return new AuthorizeTransactionUseCase.AuthorizeTransactionResult(transactionId, "AUTHORIZED",
