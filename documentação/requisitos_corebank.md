...
* **P04 - Consistência eventual validada em teste:** Garantir, por testes automatizados, que a projeção de saldo em Redis pode permanecer defasada por até 5 segundos, sem quebrar o comportamento esperado da API.
* **P05 - Projeção de saldo mais determinística:** Ajustar o processo de atualização da projeção para calcular o saldo novo de forma explícita e idempotente, em vez de depender de estado derivado de forma simplificada.
